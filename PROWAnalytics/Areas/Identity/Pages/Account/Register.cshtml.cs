...
namespace PROWAnalytics.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            BiproAnalyticsDBContext context)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirma tu correo",
                        $"Nos da mucho gusto tenerte entre nosostros. El equipo de Prow le da una cordial bienvenida.\n" +
