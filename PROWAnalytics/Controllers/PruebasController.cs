...
namespace PROWAnalytics.Controllers
{
    public class PruebasController : Controller
    {
        ...
        public async Task<IActionResult> Dashboard()
        {
            ...
            var vmcurrentUserId = currentUser.FindFirst(ClaimTypes.NameIdentifier).Value;
        ...
        public async Task<IActionResult> Create([Bind("Id,FechaDiagnostico,Lugar,DiagnosticoCovid,IdTrabajador,UbicacionId,IdUnidad,IdArea")] Prueba prueba)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FechaDiagnostico,Lugar,DiagnosticoCovid,IdTrabajador,UbicacionId,IdUnidad,IdArea")] Prueba prueba)
        {
            if (id != prueba.Id)
            {
                return NotFound();
