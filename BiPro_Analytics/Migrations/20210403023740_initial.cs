        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReporteContagio_Areas_AreaId",
                        column: x => x.AreaId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiagnosticoCovid = table.Column<string>(maxLength: 200, nullable: false),
                    FechaHoraRegistro = table.Column<DateTime>(nullable: false),
                    linkArchivo = table.Column<string>(nullable: true),
                    IdTrabajador = table.Column<int>(nullable: false),
                    TrabajadorIdTrabajador = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pruebas_Pruebas_PruebaId",
                        column: x => x.PruebaId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstatusEnCasa = table.Column<int>(nullable: false),
                    EstatusEnHospital = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReporteContagio_AreaId",
